...
class CarEnv(Env):
    ...
    def __init__(self):
        ...
        creature = car.Car()
        self.task = PressWithSpecificForce(creature)
        ...
        self.action_space = Box(low = np.array([-10, 0]),
                                high = np.array([10, 10]),
        ...
        # For MlpPolicy - Use below structure
    ...
    def getReward(self):
        ...
        reward = 0   # This reward avoids stagnation
        ...
        # In order to incentivize the agent to stay on top of button once it reaches there
        reward += self.task._button._num_activated_steps
        # print(self.task._button._num_activated_steps)
